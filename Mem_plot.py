...
def plot_model_comparison():
    ...
    # 保存图表
    plt.savefig('h:\\work\\images\\Mem_model_comparison_two_datasets.png', bbox_inches='tight', dpi=300)
    plt.savefig('h:\\work\\images\\Mem_model_comparison_two_datasets.pdf', bbox_inches='tight')
    plt.savefig('h:\\work\\images\\Mem_model_comparison_two_datasets.svg', bbox_inches='tight', format='svg')
    
    print("\n图表已保存到 h:\\work\\images\\Mem_model_comparison_two_datasets.png、.pdf 和 .svg")
