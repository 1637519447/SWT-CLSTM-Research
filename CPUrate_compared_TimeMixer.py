...
datasets = [
    {
        ...
        'results_dir': 'h:\\work\\alibaba_cpu_timemixer_results_30s\\'
    },
    {
        'name': 'Google_5m',
        'file': 'h:\\work\\Google_cpu_util_aggregated_5m.csv',
        'results_dir': 'h:\\work\\google_cpu_timemixer_results_5m\\'
    }
]

# 创建统一的结果目录
unified_results_dir = 'h:\\work\\CPU_timemixer_unified_results\\'
